...
//   }
   ...
   private void initialize() {
      	...
      	public void mouseClicked(MouseEvent e) {
      		if(Ch1.isSelected() == true || Ch2.isSelected() == true || Ch3.isSelected() == true || 
 				   Ch4.isSelected() == true || Ch5.isSelected() == true || Ch6.isSelected() == true || Ch7.isSelected() == true || Ch8.isSelected() == true) {
 					...
 					JOptionPane.showMessageDialog(null, "Ã¼Å©¹Ú½º¸¦ ´­·¯ÁÖ¼¼¿ä!");
 				}
      ...
      lblNewLabel_4.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
      ...
      JPanel JP_m = new JPanel() { //ÆÐ³Î¿¡ ÀÌ¹ÌÁö ³ÖÀ½
			@Override
			protected void paintComponent(Graphics g) {
      ...
      lblNewLabel_6.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
